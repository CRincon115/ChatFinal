...
import com.example.chatalpha.adapters.UsersAdapters;
import com.example.chatalpha.databinding.ActivityUsersBinding;
import com.example.chatalpha.listeners.UserListener;
import com.example.chatalpha.models.User;
...
public class UsersActivity extends AppCompatActivity implements UserListener {
    ...
    private void showErrorMesssage() {
        binding.textErrorMessage.setText(String.format("%s", "No hay usuarios disponibles"));
